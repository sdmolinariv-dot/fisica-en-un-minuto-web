  ...
  return (
    <>
      <Hero
        ...
        supportLine="432.188 personas ya hacen de la curiosidad una conversación."
        mobileMedia={
      ...
      <section className="bg-ink px-4 py-20 sm:px-6 lg:px-8 lg:py-28">
        <div className="mx-auto max-w-7xl">
          <div>
            <SectionHeading
              eyebrow="Métricas · corte al 13 de agosto de 2026"
              title="Una comunidad que llega por curiosidad y se queda por la ciencia."
              description="Resultados de los últimos 30 días en Instagram, actualizados el 13 de agosto de 2026."
            ...
            <p className="mt-6 max-w-3xl text-sm leading-6 text-white/60">
              ...
              seguidores y crecimiento corresponden al período indicado; los seguidores reflejan el registro al 13 de agosto.
            </p>
          </div>
        </div>
      </section>
